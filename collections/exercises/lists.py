...
new_items = [False, -4.6, '87']
adding_practice = adding_practice + new_items
print(adding_practice)
...
# append and insert require arguments inside the (). Add the items 1138 and ‘20 meters’ to the 
# the list - the number at the start and the string at the end. Print the updated list to confirm the changes.
